...
function resolve(requestLength: number, usedCaches: number[][]) {
    ...
    if (usedCaches.reduce((a, b) => a + b[1], 0) >= STORAGE_LENGTH) return FAILED_VALUE;
...
console.log(resolve(1, [[0, 1], [3, 2]]))
console.log(resolve(5, [[0, 1], [3, 2]]))
console.log(resolve(5, [[0, 1], [3, 2],[8,4]]))
console.log(resolve(5, [[0, 1], [8,4]]))
