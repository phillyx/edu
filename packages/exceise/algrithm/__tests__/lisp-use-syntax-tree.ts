import {evaluate} from '../src/lisp/lisp-use-syntax-tree'
// console.log(evaluate('(div 10 add(2 3))'))
// console.log(evaluate('(add (sub (div 8 2) (mul 1 9)) 20)'))
describe('lisp generated by syntax tree', () => {
  ...
  it('(mul 3 (add 1 2 3) 2)', () => {
    const ret = evaluate('(mul 3 (add 1 2 3) 2)')
    expect(ret).toEqual(36)
  })
  it('(mul 3 -7)', () => {
